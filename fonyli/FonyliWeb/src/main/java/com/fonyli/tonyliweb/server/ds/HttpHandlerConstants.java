...
public interface HttpHandlerConstants {
	...
	public final String		   API_SELECT_TEACHER = "/ideas/poemWriter/markov-chain/api/v1/selectTeacher";
	
	public final Class HANDLER_API_WRITE_POEM = WritePoemHandler.class;
	public final String		   API_WRITE_POEM = "/ideas/poemWriter/markov-chain/api/v1/writePoem";
	
	public final Class HANDLER_API_UPLOAD_FILE = UploaderHttpHandler.class;
	public final String		   API_UPLOAD_FILE = "/ideas/poemWriter/markov-chain/api/v1/uploadFile";
	
	public final Class HANDLER_API_FORM = FormHttpHandler.class;
	public final String		   API_FORM = "/ideas/poemWriter/markov-chain/api/v1/";
